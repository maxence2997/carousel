...
Fixed-capacity FIFO circular buffer backed by a pre-allocated array. If you need concurrent access, use [RingQueue](ring-queue.md) or [ConcurrentQueue](concurrent-queue.md).
